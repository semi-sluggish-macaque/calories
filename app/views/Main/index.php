        ...
        <div class="welcome__right">
            <div class="welcome__block card-registr">
                <div class="card-registr__body" data-block="registration">
                    ...
                    <form method="post" action="" class="card-registr__form form-registration" id="form-1">
                    ...
                    <button type="submit" data-id="sign-in" class="card-registr__sign-in-btn">
                ...
                <div class="card-registr__body hide" data-block="sign-in">
                    ...
                    <h3 class="card-registr__subtitle">Let's get started</h3>
                    <form method="post" action="main/login" class="card-registr__form form-registration" id="form-2">
                        <label for="input_email">Email</label>
                        <input data-id="input_email" type="email" tabindex="2" name="email"
                               class="form-registration__email"/>
                        <label for="input_password">Password</label>
                    ...
                    <button type="submit" data-id="create-account" class="card-registr__sign-in-btn">
                        Create an account
                    </button>
                </div>
            </div>
